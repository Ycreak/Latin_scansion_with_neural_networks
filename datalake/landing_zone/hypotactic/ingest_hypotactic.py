from datalake.landing_zone.hypotactic.harvester import Harvester
...
class Hypotactic:
    ...
    def run(self, destination_path: str) -> None:
        ...
        for poem in poems:
            ...
            page = self.harvester.run(
                f"https://hypotactic.com/latin/index.html?Use_Id={poem}"
            )
        ...
        for text in prose:
            ...
            page = self.harvester.run(
                f"https://hypotactic.com/latin/index.html?Use_Id={text}"
            )
