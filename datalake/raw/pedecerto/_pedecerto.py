...
class Pedecerto:
    ...
    def _process_line(self, given_line):
        ...
        for w in given_line("word"):
            ...
            split_scansion = [
                scansion[i : i + 2] for i in range(0, len(scansion), 2)
            ]  # per two characters
            ...
            for i in range(len(word_syllable_list)):
                ...
                # No scansions available? Elision.
                    ...
                    length = (
                        "elision"  # Luckily elision happens only at the end of a word
                    )
                ...
                syllable_object: Syllable = Syllable(
                    syllable=current_syllable, word=w.text, length=length
                )
        ...
        return line_sequence_label_list[
            :-1
        ], True  # Boolean to denote success of syllabification
