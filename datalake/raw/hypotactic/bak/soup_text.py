...
class TextSoup:
    ...
    def process(self, lines, cache: dict) -> None:
        ...
        for line in lines:
            meter: str = (
                line["data-metre"] if line and "data-metre" in line.attrs else "Unknown"
            )
            ...
            for word in words:
                ...
                for syllable in syllables:
                    clean_syllable: str = hypotactic_util.format_string(
                        syllable.get_text()
                    )
            ...
            cache["lines"].append({"author": author, "meter": meter, "line": line_list})
